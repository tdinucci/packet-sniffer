...
const uint16_t PROTOCOL_ALL = 0x0300;  // shifted for network order, actual value is 0x0003
const uint16_t PROTOCOL_IP = 0x0008;  // shifted for network order, actual value is 0x0800
