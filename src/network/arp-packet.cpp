...
tuple<string, string> get_hardware_addresses(const vector<uint8_t>& packet, uint8_t addr_len);
tuple<string, string> get_software_addresses(const vector<uint8_t>& packet, uint8_t addr_len);

ArpPacket::ArpPacket(vector<uint8_t>& packet) {
